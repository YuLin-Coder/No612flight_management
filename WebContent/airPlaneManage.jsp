      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="#">飞机管理<span class="sr-only">(current)</span></a></li>
          </ul>
          <ul class="nav nav-sidebar">
          	<li><a href="orderManage.jsp">机票订单管理</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">当前共有${airPlanesListLength}航班</h2>
          <div class="table-responsive">
            ...
            <button type="button" class="btn btn-lg btn-success" onclick="javascript:window.location.href='addAirPlane.jsp';">添加飞机</button>
          </div>
        </div>
      </div>
    </div>
